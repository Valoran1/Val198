document.addEventListener("DOMContentLoaded",()=>{try{addBubble("assistant","I’m Valoran. Stop lying to yourself. What’s the real problem holding you back?");}catch(e){console&&console.warn(e)}});
...
async function typeOut(el, text, delay=14){
  el.textContent="";
